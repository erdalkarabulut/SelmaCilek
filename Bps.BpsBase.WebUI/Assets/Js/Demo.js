(function() {
    ...
    DXDemo.adjustDemoSettingsBlock = function() {
        ...
        if(demoArea.clientWidth <= (parseInt(demoSettings.style.width, 10) + controlArea.clientWidth))
            ...
            demoSettings.style.width = demoSettings.scrollWidth + 'px';
        }
    };
    ...
    //        e.cancel = true;
    //}
    DXDemo.treeViewInit = function() {
        window.NavControl = new navigationControl(NavigationTreeView, NavigationBreadCrumbsButton);
        NavControl.init();
    };
