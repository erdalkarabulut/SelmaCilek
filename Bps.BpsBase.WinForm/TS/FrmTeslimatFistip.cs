...
{
    public partial class FrmTeslimatFistip : BPS.Windows.Base.FrmChildBase
    {
        private ITsftipService _sinifService;
        private IGnkxmlService _sinifyerlesimService;
        private GNKXML _sinifyerlesim;

        private static IList<TSFTIP> list;
        private BindingList<TSFTIP> bindingList;
        private BindingList<TSFTIP> oldBindingList;
        ...
        public FrmTeslimatFistip(ITsftipService sinifService, IGnkxmlService sinifyerlesimService, 
            IGnyetkService gnyetkService)
        {
            InitializeComponent();
        ...
        private void LoadGrid()
        {
            ...
            bindingList = new BindingList<TSFTIP>(list);
            oldBindingList = new BindingList<TSFTIP>(bindingList.Select(item => item.ShallowCopy()).ToList());
            tSFTIPBindingSource.DataSource = bindingList;
        ...
        protected override void barKaydet_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            try
            {
                StandardResponse<TSFTIP> response;
                var bindigSources = tSFTIPBindingSource.List;
                var datas = new List<TSFTIP>();
                foreach (var bind in bindigSources)
                {
                    datas.Add((TSFTIP)bind);
                }
        ...
        protected override void barOrtamBelgeAkisi_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            FrmBelgeAkis form = new FrmBelgeAkis(global, "TSFTIP", id);
            form.ShowDialog();
        }
        ...
        protected override void barOrtamEk_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            int id = Convert.ToInt32(gridView1.GetFocusedRowCellValue("Id"));
            FrmFileManager form = new FrmFileManager(global, "TSFTIP", id);
            form.ShowDialog();
        }
