...
{
	partial class FrmParcaUretimRota
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmParcaUretimRota));
			...
			this.groupControl2.Text = "Tüm Operasyonlar";
			// 
			// gridControl1
			// 
			...
			// gridColumn16
			// 
			this.gridColumn16.Caption = "Bölüm";
			this.gridColumn16.ColumnEdit = this.repLkedBolum;
			this.gridColumn16.FieldName = "PARENT";
			...
			this.gridColumn4.FieldName = "HARKOD";
			...
			// gridColumn5
			// 
			this.gridColumn5.Caption = "Bölüm";
			this.gridColumn5.ColumnEdit = this.repLkedBolum2;
			this.gridColumn5.FieldName = "PARENT";
			...
			// gridColumn8
			// 
			this.gridColumn8.Caption = "İşlem";
			...
			this.groupControl1.Text = "Parça Operasyonları";
			// 
			// butKaydet
			// 
			...
			this.Name = "FrmParcaUretimRota";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "FrmParcaUretimRota";
			this.Load += new System.EventHandler(this.FrmParcaUretimRota_Load);
