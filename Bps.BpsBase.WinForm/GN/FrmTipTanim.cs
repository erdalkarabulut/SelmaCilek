...
{
    public partial class FrmTipTanim : Base.FrmChildBase
    {
        private IGntipiService _sinifService;
        private GNTIPI _sinif;

        private IGnkxmlService _sinifyerlesimService;
        private GNKXML _sinifyerlesim;

        private static IList<GNTIPI> list;
        private BindingList<GNTIPI> bindingList;
        ...
        public FrmTipTanim(IGntipiService sinifService, IGnkxmlService sinifyerlesimService, 
        ...
        private void LoadData()
        {
            ...
            bindingList = new BindingList<GNTIPI>(list);
        ...
        protected override void barOrtamEk_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            FrmFileManager form = new FrmFileManager(global, "GNTIPI", id);
            form.ShowDialog();
        }
        ...
        public void kaydet(object itemTag)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    var response = new StandardResponse<GNTIPI>();
