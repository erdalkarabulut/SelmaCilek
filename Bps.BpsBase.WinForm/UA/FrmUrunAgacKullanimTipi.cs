...
{
    public partial class FrmUrunAgacKullanimTipi : BPS.Windows.Base.FrmChildBase
    {
        private IUakltpService _sinifService;
        private IGnkxmlService _sinifyerlesimService;

        private UAKLTP _sinif;
        private GNKXML _sinifyerlesim;

        private BindingList<UAKLTP> bindingList;
        private BindingList<UAKLTP> oldBindingList;
        ...
        public FrmUrunAgacKullanimTipi(IUakltpService sinifService, IGnkxmlService sinifyerlesimService, IGnyetkService gnyetkService)
        {
            InitializeComponent();
        ...
        private void FrmUrunAgacKullanimTipi_Load(object sender, EventArgs e)
        {
        ...
        private void LoadGrid()
        {
            ...
            bindingList = new BindingList<UAKLTP>(sadegas);
            oldBindingList = new BindingList<UAKLTP>(bindingList.Select(item => item.ShallowCopy()).ToList());
            uAKLTPBindingSource.DataSource = bindingList;
        ...
        protected override void barKaydet_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            try
            {
                StandardResponse<UAKLTP> response;
                var bindigSources = uAKLTPBindingSource.List;
                var datas = new List<UAKLTP>();
                foreach (var bind in bindigSources)
                {
                    datas.Add((UAKLTP)bind);
                }
        ...
        protected override void barOrtamBelgeAkisi_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            FrmBelgeAkis form = new FrmBelgeAkis(global, "UAKLTP", id);
            form.ShowDialog();
        }
        ...
        protected override void barOrtamEk_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            int id = Convert.ToInt32(gridView1.GetFocusedRowCellValue("Id"));
            FrmFileManager form = new FrmFileManager(global, "UAKLTP", id);
            form.ShowDialog();
        }
