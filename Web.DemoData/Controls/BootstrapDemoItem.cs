...
using DevExpress.Web.Demos.Models.Bootstrap;

namespace DevExpress.Web.Demos.Controls {
	...
	public class BootstrapDemoItemControlBuilder : ControlBuilder {
		...
		public override void Init(TemplateParser parser, ControlBuilder parentBuilder, Type type, string tagName, string id, IDictionary attribs) {
			...
			if(!string.IsNullOrEmpty(PageVirtualPath)) {
				string groupKey = "";
				string demoKey = "";
				Models.Utils.FindDemoKeysByVirtualPath(PageVirtualPath, out groupKey, out demoKey);
