...
namespace DevExpress.Web.Demos.DataModels {
		...
		public class TableData {
			...
			public string ConnectionString {
				get {
					...
					return Models.Utils.PatchConnectionStrings ? DbEngineDetector.PatchConnectionString(sqlExpressString) : sqlExpressString;
				}
			}
		}
