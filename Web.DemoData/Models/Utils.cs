...
using CodeFormatter = DevExpress.Web.Demos.Common.CodeFormatter;
...
namespace DevExpress.Web.Demos.Models {
	...
	public static class Utils {
        ...
        public static void CurrentStoredTheme(string cookieKey, string value)
        {
            Context.Response.Cookies[cookieKey].Value = value;
        }
