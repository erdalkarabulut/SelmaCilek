...
using DevExpress.Web.Demos.Models.Search;

namespace DevExpress.Web.Demos.Models.Bootstrap {
	[XmlRoot("Demos")]
	public class BootstrapDemosModel {
		const string Demos3ModelPath = "Data.Bootstrap.Demos3.xml";
#if ASPNETCORE
		const string DemosModelPath = "Data.Bootstrap.AspNetCore.Demos.xml";
#else
